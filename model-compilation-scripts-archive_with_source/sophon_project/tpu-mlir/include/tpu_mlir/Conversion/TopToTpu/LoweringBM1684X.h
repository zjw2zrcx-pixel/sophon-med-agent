...
LOWERING_BM1684X(ChunkGatedDeltaRule)
LOWERING_BM1684X(RecurrentGatedDeltaRule)
LOWERING_BM1684X(SequentialRecurrentGatedDeltaRule)
LOWERING_BM1684X(ConcatSlice)
...
LOWERING_BM1684X(A16MatMul)
LOWERING_BM1684X(Fp8MatMul)
LOWERING_BM1684X(A16Gather)
...
LOWERING_BM1684X(SelectiveScan)
