...
// recurrent_gated_delta_rule.c also contains the sequential kernel. Include
// its dynamic controller in this translation unit so generated kernel and
// registration symbols are emitted exactly once.
#define RECURRENT_GATED_DELTA_RULE_DEVICE_INCLUDED 1
#include "sequential_recurrent_gated_delta_rule_ctrl.c"
